...
public class DialogService : IDialogService
{
    ...
    {
        var settings = new SettingsWindow(configService, clipboardService, startupService, logger, modelCatalog, modelManager, textFormatter, hfService, ggufStore, inputInjectorService, transcriptionService, audioRecorderService, this, themeService);
